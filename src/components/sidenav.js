    ...
    render () {
        ...
        return (
            ...
            {/* <!-- close --> */}
                ...
                <a className="social social--small social-facebook" href="#" target="_blank" aria-label="facebook">
                ...
                <a className="social social--nobase" href="#" target="_blank" aria-label="telegram" style={padSideNav}>
