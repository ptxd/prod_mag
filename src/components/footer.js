            ...
            <div className="footer__widgets">
                ...
                <div className="col-lg-4 col-md-6">
                    ...
                    <div className="socials">
                        <a href="https://www.facebook.com/guild.crypto.3" target="_blank" className="social social-facebook" aria-label="facebook"><i className="ui-facebook"></i></a>
                        <a href="https://twitter.com/guildcrypto" target="_blank" className="social social-twitter" aria-label="twitter"><i className="ui-twitter"></i></a>
